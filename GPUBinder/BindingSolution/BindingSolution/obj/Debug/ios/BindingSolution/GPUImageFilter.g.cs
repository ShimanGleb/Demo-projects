...
namespace BindingSolution {
	[Register("GPUImageFilter", true)]
	public unsafe partial class GPUImageFilter : GPUImageOutput {
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("GPUImageFilter");
		...
		[Export ("init")]
		public GPUImageFilter () : base (NSObjectFlag.Empty)
		{
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected GPUImageFilter (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal GPUImageFilter (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[CompilerGenerated]
		public GPUImageFilter (string vertexShaderString, string fragmentShaderString)
			: base (NSObjectFlag.Empty)
		{
			if (vertexShaderString == null)
				throw new ArgumentNullException ("vertexShaderString");
			if (fragmentShaderString == null)
				throw new ArgumentNullException ("fragmentShaderString");
			var nsvertexShaderString = NSString.CreateNative (vertexShaderString);
			var nsfragmentShaderString = NSString.CreateNative (fragmentShaderString);
			
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
			if (IsDirectBinding) {
				InitializeHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr (this.Handle, Selector.GetHandle ("initWithVertexShaderFromString:fragmentShaderFromString:"), nsvertexShaderString, nsfragmentShaderString), "initWithVertexShaderFromString:fragmentShaderFromString:");
			} else {
				InitializeHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSendSuper_IntPtr_IntPtr (this.SuperHandle, Selector.GetHandle ("initWithVertexShaderFromString:fragmentShaderFromString:"), nsvertexShaderString, nsfragmentShaderString), "initWithVertexShaderFromString:fragmentShaderFromString:");
			}
			NSString.ReleaseNative (nsvertexShaderString);
